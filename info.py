...
API_ID = int(environ.get('API_ID', '24699616'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5359624166').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001917320401').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TamilzanMr:TamilzanMr@cluster0.1gcdjrz.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002071195970'))
...
URL = "https://tamilan-bot-3pse.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tamilan-bot-3pse.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tamilan-bot-3pse.onrender.com/".format(FQDN)
else:
    URL = "https://tamilan-bot-3pse.onrender.com/".format(FQDN)
